...
const OrderCreate = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    orderService.create(formData).then(() => { setLoading(false); navigate('/admin/order'); }).catch(err => { setLoading(false); alert('Lỗi: ' + (err.response?.data || err.message)); });
  };
