    ...
    <div className="admin-page">
      <div className="page-header">
        <div className="flex-row">
          <Link to="/admin/customer" className="btn-icon text-muted"><ArrowLeft size={20}/></Link>
      ...
      <form onSubmit={handleSubmit} className="card-panel" style={{ padding: '2rem' }}>
        ...
        <div className="form-actions mt-4" style={{borderTop: '1px solid #e2e8f0', paddingTop: '1.5rem'}}>
          <Link to="/admin/customer" className="btn-secondary" style={{padding: '0.8rem 1.5rem'}}>Hủy</Link>
