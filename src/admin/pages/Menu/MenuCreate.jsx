...
const MenuCreate = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    menuService.create(formData).then(() => { setLoading(false); navigate('/admin/menu'); }).catch(err => { setLoading(false); alert('Lỗi: ' + (err.response?.data || err.message)); });
  };
