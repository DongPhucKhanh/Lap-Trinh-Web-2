...
const CustomerCreate = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    customerService.create(formData).then(() => { setLoading(false); navigate('/admin/customer'); }).catch(err => { setLoading(false); alert('Lỗi: ' + (err.response?.data || err.message)); });
  };
