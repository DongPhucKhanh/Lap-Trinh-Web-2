...
const policies = {
  'doi-tra': {
    ...
    content: `
      ...
      <p>SnackHub hỗ trợ đổi trả sản phẩm trong vòng <strong>7 ngày</strong> kể từ khi nhận hàng, với các điều kiện sau:</p>
      <ul>
      ...
      <ol>
        <li>Liên hệ hotline <strong>0123 456 789</strong> hoặc gửi email về <strong>contact@snackhub.vn</strong></li>
        <li>Cung cấp mã đơn hàng, hình ảnh sản phẩm lỗi</li>
        <li>SnackHub xác nhận và gửi hướng dẫn gửi trả hàng</li>
  ...
  'giao-hang': {
    ...
    content: `
      ...
      <p>SnackHub giao hàng trên <strong>toàn quốc</strong> thông qua các đối tác vận chuyển uy tín.</p>
      ...
      <h3>4. Lưu ý</h3>
      <p>Thời gian giao hàng có thể thay đổi tùy thuộc vào điều kiện thời tiết, lễ tết hoặc các sự kiện bất khả kháng. SnackHub sẽ thông báo cho bạn nếu có sự chậm trễ.</p>
    `
  },
  'dieu-khoan': {
    ...
    content: `
      <h3>1. Giới thiệu</h3>
      <p>Chào mừng bạn đến với SnackHub. Khi sử dụng website và dịch vụ của chúng tôi, bạn đồng ý tuân thủ các điều khoản và điều kiện dưới đây.</p>
      ...
      <ul>
        ...
        <li>SnackHub có quyền khóa tài khoản nếu phát hiện hành vi vi phạm</li>
      </ul>
      ...
      <ul>
        ...
        <li>SnackHub có quyền từ chối đơn hàng nếu sản phẩm hết hàng hoặc có thông tin không chính xác</li>
      </ul>
      
      <h3>4. Quyền sở hữu trí tuệ</h3>
      <p>Toàn bộ nội dung trên website (logo, hình ảnh, bài viết) thuộc quyền sở hữu của SnackHub và được bảo vệ bởi luật sở hữu trí tuệ.</p>
    `
  },
  'bao-mat': {
    ...
    content: `
      ...
      <p>SnackHub thu thập các thông tin cần thiết khi bạn đăng ký tài khoản hoặc đặt hàng, bao gồm:</p>
      <ul>
      ...
      <p>Bạn có quyền yêu cầu truy cập, chỉnh sửa hoặc xóa thông tin cá nhân bất kỳ lúc nào bằng cách liên hệ với chúng tôi qua email <strong>contact@snackhub.vn</strong>.</p>
    `
  }
};
